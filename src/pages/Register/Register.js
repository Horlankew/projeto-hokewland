  ...
  return(
    <div className='register'>
      <div className='register-container'>
        <h2>Criar uma conta HokewLand</h2>
        ...
        <form className='register-form' onSubmit={handleSubmit}>
          ...
          <div className='terms'>
            ...
            <label>Eu concordo com os termos do <a href='https://politicaprivacidade.com/'>Acordo de usuário da conta HokewLand</a> e confirmo que li a <a href='https://politicaprivacidade.com/'>Política de privacidade da HokewLand</a>.</label>
          </div>
